...
const CARDS = [
  { icon: '🏷️', title: 'Категории', text: '«Полочки» для строк: доход или расход и счёт учёта. Определяют, как строка попадёт в отчёт и в колонку счёта.' },
            ...
            <div>
              ...
              <div className="guide-branch">
                <div className="guide-branch-box">
                  ...
                  <p>Складываются в ОПиУ (прибыль) и ДДС (движение денег). Клик по статье показывает документы-источники.</p>
                </div>
                <div className="guide-branch-box">
