...
const CARDS = [
  ...
  { icon: '⬇', title: 'Выгрузка', text: 'Готовые документы одной кнопкой скачиваются CSV-отчётом с фиксированными столбцами (дата, контрагент, категория, тип, кол-во, цена, сумма).' },
  { icon: '⚙️', title: 'Настройки', text: 'Кнопка скачивания отчёта и управление командой (добавить, сменить роль, удалить) — только у администратора.' },
]
